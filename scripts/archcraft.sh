yay -S sqlite mariadb mariadb-libs postgresql postgresql-libs redis libxml2 zlib ncurses5-compat-libs gdbm nss openssl readline libffi yaml-cpp unzip make gcc wget curl fzf openssl libyaml ripgrep zsh sqlite mariadb libmariadbclient mariadb-clients postgresql postgresql-libs redis memcached imagemagick ffmpeg mupdf mupdf-tools poppler yarn libxml2 memcached;
...
# Bspwm
cp -r ../bspwm/bspwmrc sxhkdrc ~/.config/bspwm/
